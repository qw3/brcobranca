    ...
    module Template
      ...
      module Rghost
        ...
        def modelo_generico_cabecalho(doc, boleto)
          ...
          doc.show (boleto.is_a?( Brcobranca::Boleto::Bradesco ) ) ? "" : boleto.quantidade
        ...
        def modelo_generico_rodape(doc, boleto)
          ...
          doc.show (boleto.is_a?( Brcobranca::Boleto::Bradesco ) ) ? "R$" : boleto.moeda
          doc.moveto :x => '8 cm' , :y => '13.5 cm'
          doc.show (boleto.is_a?( Brcobranca::Boleto::Bradesco ) ) ? "" : boleto.quantidade
          doc.moveto :x => '11 cm' , :y => '13.5 cm'
          doc.show (boleto.is_a?( Brcobranca::Boleto::Bradesco ) ) ? "" : boleto.valor.to_currency
